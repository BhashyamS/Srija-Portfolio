...
export default function ProjectCard({
  ...
  return (
    <button
      ...
      className={`group flex h-[210px] min-w-[230px] max-w-[230px] snap-start flex-col justify-between rounded-2xl border p-4 text-left transition-all duration-300 ${
        active
    ...
    >
      <div>
        ...
        <div className="mt-3 flex h-[52px] items-center justify-center overflow-hidden rounded-xl border border-white/10 bg-gradient-to-br from-blue-500/15 to-purple-500/15">
          <img
